...
main = do
    ...
    quickCheck $ testCase (BencodeDict.stringifyBoard [(1,1,'x'),(0,0,'o'),(0,2,'x'),(1,0,'o')]) "d1:0d1:v1:x1:xi1e1:yi1ee1:1d1:v1:o1:xi1e1:yi0ee1:2d1:v1:x1:xi0e1:yi2ee1:3d1:v1:o1:xi0e1:yi0eee"
